...
##            print(" ++ " , sIDTemp, " ++ ", ZaehlerGeloescht, " ++ ")
            y = 1
            ZuLoeschendeIDs += [sIDTemp] 
            ZaehlerGeloescht+=1


    print(ZuLoeschendeIDs)
    #ZuLoeschendeIDs.replace("(", "")
    #ZuLoeschendeIDs.replace(")", "")
    #print(ZuLoeschendeIDs)
    
    #TPZuLoeschendeIDs = str(ZuLoeschendeIDs)
    #TPZuLoeschendeIDs = [ZuLoeschendeIDs.split(",")]
